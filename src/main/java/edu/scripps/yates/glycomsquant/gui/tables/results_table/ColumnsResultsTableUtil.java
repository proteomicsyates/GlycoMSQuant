...
public class ColumnsResultsTableUtil {
	private static Logger log = Logger.getLogger("log4j.logger.org.proteored");

	private static ColumnsResultsTableUtil instance;
	...
	private ColumnsResultsTableUtil() {
	}

	public static ColumnsResultsTableUtil getInstance() {
		if (instance == null) {
			instance = new ColumnsResultsTableUtil();
		}
		return instance;
	}

	public List<Object> getGlycoSiteInfoList(GlycoSite glycoSite, boolean calculateProportionsByPeptidesFirst,
			List<ColumnsResultsTable> list, int index) {
