...
public class ScrollableResultsTable extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 725114162692158140L;

	private static Logger log = Logger.getLogger(ScrollableResultsTable.class);

	private MyResultsTable table = new MyResultsTable();
	...
	public ScrollableResultsTable(MyResultsTable jtable, int wide, boolean calculateProportionsByPeptidesFirst) {
		if (jtable != null) {
			table = jtable;
		}
		table.setModel(new MyResultsTableModel(calculateProportionsByPeptidesFirst));

		// Set renderer for painting different background colors
		table.setDefaultRenderer(Object.class, new MyResultsTableCellRenderer());
		initializeUI(wide);
	}

	public ScrollableResultsTable(MyResultsTable jtable, boolean calculateProportionsByPeptidesFirst) {
		this(jtable, 600, calculateProportionsByPeptidesFirst);
	}

	public ScrollableResultsTable(int wide, boolean calculateProportionsByPeptidesFirst) {
	...
	public ScrollableResultsTable(boolean calculateProportionsByPeptidesFirst) {
		this(900, calculateProportionsByPeptidesFirst);
	}
...
//			});
	...
	public MyResultsTable getTable() {
		return table;
	}
