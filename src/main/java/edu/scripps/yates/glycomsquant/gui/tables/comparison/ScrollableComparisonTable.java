...
public class ScrollableComparisonTable extends JScrollPane {
	/**
	 * 
	 */
	private static final long serialVersionUID = 725114162692158140L;

	private static Logger log = Logger.getLogger(ScrollableComparisonTable.class);

	private final MyComparisonTable table = new MyComparisonTable();

	private TableRowSorter<TableModel> sorter = null;

	private Comparator comp;

	public ScrollableComparisonTable() {

		table.setModel(new MyComparisonTableModel());

		// Set renderer for painting different background colors
		table.setDefaultRenderer(Object.class, new MyComparisonTableCellRenderer());
		initializeUI();
	}
