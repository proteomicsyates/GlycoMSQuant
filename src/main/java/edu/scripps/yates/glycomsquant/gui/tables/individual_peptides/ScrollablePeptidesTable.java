...
public class ScrollablePeptidesTable extends JScrollPane {
	...
	private final MyPeptidesTable table = new MyPeptidesTable();
	...
	public ScrollablePeptidesTable(boolean extended) {
		...
		table.setModel(new MyPeptidesTableModel());

		// Set renderer for painting different background colors
		table.setDefaultRenderer(Object.class, new MyPeptidesTableCellRenderer(extended));
		initializeUI();
	}
